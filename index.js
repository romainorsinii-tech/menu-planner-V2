class MenuPlanner {
    ...
    // Nouvelle méthode : Analyser les types utilisés dans les plats
    analyzeUsedTypes() {
    ...
    // Nouvelle méthode : Importer des données
    importData(event) {
    ...
    // Nouvelle méthode : Valider les données importées
    validateImportData(data) {
        return data && (data.dishes || data.types);
    }
    
    // Nouvelle méthode : Fusionner les plats sans doublons
    ...
    // Nouvelle méthode : Fusionner les types sans doublons
    ...
    // Nouvelle méthode : Afficher une notification
